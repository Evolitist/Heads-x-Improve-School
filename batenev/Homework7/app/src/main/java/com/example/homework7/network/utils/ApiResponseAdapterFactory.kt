...
class ApiResponseAdapterFactory : CallAdapter.Factory() {
    override fun get(
        ...
        check(returnType is ParameterizedType) {
            "Return type must be parameterized as Call<ApiResponse<Type>> or Call<ApiResponse<out Type>>"
        }
        ...
        check(responseType is ParameterizedType) {
            "Response must be parameterized as ApiResponse<Type> or ApiResponse<out Type>"
        }
